package com.foundly.foundlyplatform.shared.infrastructure.documentation.openapi.configuration;
...
public class OpenApiConfiguration {
    ...
    public OpenAPI foundlyPlatformOpenApi() {
        ...
        openApi.info(new Info()
                        ...
                        .contact(new Contact()
                                .name("Foundly Support")
                                .email("support@foundly.com")
                                .url("https://foundly.com/support"))
                        .license(new License()
                                .name("Apache 2.0")
